...
cl.exe ../src/main.c /Fe:%1.exe /std:c11 /permissive- /DUNITY_BUILD /Zi /GS- /Gs1000000000 /W4 %ALL_BUT_FIRST% /link /nodefaultlib /subsystem:console kernel32.lib /STACK:0x100000,0x100000
